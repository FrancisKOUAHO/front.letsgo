...
const Checkout = () => {
  ...
  const switchToCheckout = (arg: number) => {
    switch (arg) {
      ...
      case 2:
        return <BookingYourDetail handleSendCustomer={handleSendCustomer} setStep={setStep} selected={selected}/>;
      case 3:
                  ...
                  <div className='sticky top-0'>
                    <div className='c-details o-box mt-4'>
                      <div className='flex items-start gap-x-4'>
                        <p className='flex-1 mb-4'>Louvre Museum: Skip The Line + Guided Tour in English</p>
