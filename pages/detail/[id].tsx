      ...
      <>
        {
          !!data && (
            <>
              <section className='o-container o-container--margin o-container--margin--reduce' title="images carousel">
                      ...
                      <div className='c-ticket-card__content'>
                        <div className='flex items-center justify-between gap-x-2 w-full'>
                          ...
                          <div className='c-ticket-card__avis'>
                            <svg className='c-ticket-card__avis__icon' xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 24 24">
                        ...
                        <div className='c-ticket-card__reservation'>
                          <span className='c-ticket-card__reservation__price'>{data.price + '€'}</span>
                          {
                            user ? (
